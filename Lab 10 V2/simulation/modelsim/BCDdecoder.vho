...
-- BCD[0]	=>  Location: PIN_C10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- BCD[1]	=>  Location: PIN_C11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- BCD[2]	=>  Location: PIN_D12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- BCD[3]	=>  Location: PIN_C12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Mux5~0_combout\ = (\BCD[1]~input_o\ & (((\BCD[3]~input_o\)))) # (!\BCD[1]~input_o\ & (\BCD[2]~input_o\ & ((\BCD[3]~input_o\) # (\BCD[0]~input_o\))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\BCD[1]~input_o\) # ((\BCD[2]~input_o\ & (\BCD[3]~input_o\)) # (!\BCD[2]~input_o\ & (!\BCD[3]~input_o\ & \BCD[0]~input_o\)))
