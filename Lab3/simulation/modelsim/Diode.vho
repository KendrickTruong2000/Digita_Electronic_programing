...
-- d1	=>  Location: PIN_A9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- d2	=>  Location: PIN_A10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- d3	=>  Location: PIN_B10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SysClk	=>  Location: PIN_N14,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Diode IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \inst|LPM_COUNTER_component|auto_generated|ALT_INV_counter_reg_bit\ : std_logic_vector(24 DOWNTO 24);
SIGNAL \inst2|ALT_INV_8~q\ : std_logic;
...
\inst|LPM_COUNTER_component|auto_generated|ALT_INV_counter_reg_bit\(24) <= NOT \inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(24);
\inst2|ALT_INV_8~q\ <= NOT \inst2|8~q\;
...
\inst2|8~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
-- Equation(s):
-- \inst3~combout\ = (\inst1|7~q\ & \inst2|7~q\)
...
-- pragma translate_on
PORT MAP (
	clk => \inst|LPM_COUNTER_component|auto_generated|ALT_INV_counter_reg_bit\(24),
