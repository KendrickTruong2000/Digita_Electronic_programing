...
-- Design Ports Information
-- led1	=>  Location: PIN_A8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \x~0_combout\ = (\a~input_o\ & ((\b~input_o\) # (\c~input_o\))) # (!\a~input_o\ & (\b~input_o\ & \c~input_o\))
