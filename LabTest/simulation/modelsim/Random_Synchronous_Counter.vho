...
SIGNAL \inst2|8~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \inst1|8~0_combout\ = \inst1|7~q\ $ (((\inst2|8~q\) # (!\inst1|8~q\)))
...
\inst2|8~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst2|8~feeder_combout\ = \inst1|8~q\
...
\inst1|7~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst1|7~feeder_combout\ = \inst2|8~q\
...
\inst3|81\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|81~combout\ = (\inst1|8~q\ & (!\inst1|7~q\ & !\inst2|8~q\)) # (!\inst1|8~q\ & ((\inst2|8~q\)))
...
\inst3|82~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|82~0_combout\ = (\inst2|8~q\ & (\inst1|7~q\ $ (\inst1|8~q\)))
...
-- Equation(s):
-- \inst3|4~0_combout\ = (\inst1|7~q\ & (!\inst1|8~q\ & !\inst2|8~q\))
...
\inst3|84~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|84~0_combout\ = (\inst1|7~q\ & (\inst1|8~q\ & \inst2|8~q\)) # (!\inst1|7~q\ & (\inst1|8~q\ $ (\inst2|8~q\)))
...
\inst3|85\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|85~combout\ = (\inst1|8~q\) # ((!\inst1|7~q\ & \inst2|8~q\))
...
\inst3|86~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|86~0_combout\ = (\inst1|7~q\ & ((\inst1|8~q\) # (!\inst2|8~q\))) # (!\inst1|7~q\ & (\inst1|8~q\ & !\inst2|8~q\))
...
\inst3|87\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst3|87~combout\ = (\inst1|7~q\ & (\inst1|8~q\ & \inst2|8~q\)) # (!\inst1|7~q\ & ((!\inst2|8~q\)))
