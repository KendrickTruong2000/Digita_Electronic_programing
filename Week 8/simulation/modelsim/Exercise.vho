...
-- c	=>  Location: PIN_Y2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Y~0_combout\ = (\c~input_o\ & ((\b~input_o\) # (\a~input_o\))) # (!\c~input_o\ & (\b~input_o\ & \a~input_o\))
