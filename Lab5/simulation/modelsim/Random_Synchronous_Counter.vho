...
ENTITY 	Random_Synchronous_Counter IS
    PORT (
	sega : OUT std_logic;
	clk : IN std_logic;
	segb : OUT std_logic;
...
END Random_Synchronous_Counter;
...
ARCHITECTURE structure OF Random_Synchronous_Counter IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \inst11|8~0_combout\ : std_logic;
SIGNAL \inst11|8~q\ : std_logic;
SIGNAL \inst13|8~feeder_combout\ : std_logic;
SIGNAL \inst13|8~q\ : std_logic;
...
\inst11|8~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst11|8~0_combout\ = \inst11|7~q\ $ (((\inst13|8~q\) # (!\inst11|8~q\)))
...
PORT MAP (
	...
	d => \inst11|8~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst11|8~q\);

-- Location: LCCOMB_X67_Y53_N16
\inst13|8~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst13|8~feeder_combout\ = \inst11|8~q\
...
PORT MAP (
	datad => \inst11|8~q\,
	combout => \inst13|8~feeder_combout\);
...
PORT MAP (
	clk => \inst|LPM_COUNTER_component|auto_generated|counter_reg_bit[24]~clkctrl_outclk\,
	d => \inst13|8~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst13|8~q\);

-- Location: LCCOMB_X67_Y53_N18
\inst11|7~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst11|7~feeder_combout\ = \inst13|8~q\
...
-- Equation(s):
-- \inst4|81~combout\ = (\inst11|8~q\ & (!\inst11|7~q\ & !\inst13|8~q\)) # (!\inst11|8~q\ & ((\inst13|8~q\)))
...
-- Equation(s):
-- \inst4|82~0_combout\ = (\inst13|8~q\ & (\inst11|7~q\ $ (\inst11|8~q\)))
...
-- Equation(s):
-- \inst4|4~0_combout\ = (\inst11|7~q\ & (!\inst11|8~q\ & !\inst13|8~q\))
...
-- Equation(s):
-- \inst4|84~0_combout\ = (\inst11|7~q\ & (\inst11|8~q\ & \inst13|8~q\)) # (!\inst11|7~q\ & (\inst11|8~q\ $ (\inst13|8~q\)))
...
-- Equation(s):
-- \inst4|85~combout\ = (\inst11|8~q\) # ((!\inst11|7~q\ & \inst13|8~q\))
...
-- Equation(s):
-- \inst4|86~0_combout\ = (\inst11|7~q\ & ((\inst11|8~q\) # (!\inst13|8~q\))) # (!\inst11|7~q\ & (\inst11|8~q\ & !\inst13|8~q\))
...
-- Equation(s):
-- \inst4|87~combout\ = (\inst11|7~q\ & (\inst11|8~q\ & \inst13|8~q\)) # (!\inst11|7~q\ & ((!\inst13|8~q\)))
