...
-- y	=>  Location: PIN_W6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ww_a <= a;
ww_b <= b;
x <= IEEE.STD_LOGIC_1164.TO_BIT(ww_x);
...
-- Equation(s):
-- \x~0_combout\ = (\a~input_o\ & \b~input_o\)
