...
ENTITY 	Flip_flop_application IS
    PORT (
	LED0 : OUT std_logic;
	sysclk : IN std_logic;
	LED1 : OUT std_logic;
...
ARCHITECTURE structure OF Flip_flop_application IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- pragma translate_on
PORT MAP (
	i => \inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(24),
	devoe => ww_devoe,
	o => \LED0~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(23),
	devoe => ww_devoe,
	o => \LED1~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(22),
	devoe => ww_devoe,
	o => \LED2~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst|LPM_COUNTER_component|auto_generated|counter_reg_bit\(21),
	devoe => ww_devoe,
	o => \LED3~output_o\);
