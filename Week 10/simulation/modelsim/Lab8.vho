...
-- Design Ports Information
-- GE	=>  Location: PIN_A9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LT	=>  Location: PIN_A8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- A0	=>  Location: PIN_D12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A1	=>  Location: PIN_C12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \ALT_INV_GE~0_combout\ : std_logic;
...
\ALT_INV_GE~0_combout\ <= NOT \GE~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \ALT_INV_GE~0_combout\,
	devoe => ww_devoe,
	o => \GE~output_o\);

-- Location: IOOBUF_X46_Y54_N2
\LT~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
-- Equation(s):
-- \GE~0_combout\ = (\B1~input_o\ & (((\B0~input_o\ & !\A0~input_o\)) # (!\A1~input_o\))) # (!\B1~input_o\ & (\B0~input_o\ & (!\A0~input_o\ & !\A1~input_o\)))
